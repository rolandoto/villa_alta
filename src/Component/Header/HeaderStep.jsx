    ...
    return (
        ...
        <div className="max-w-7xl mx-auto w-full flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex justify-between items-center gap-4 sm:gap-10 w-full sm:w-auto">
            <Link to="/">
            <img
              src="https://github.com/rolandoto/image-pms/blob/main/WhatsApp%20Image%202025-04-22%20at%2010.10.51%20AM.jpeg?raw=true"
              alt="Logo"
                ...
                <React.Fragment key={step}>
                  <div
                    className={`flex items-center gap-1 ${
                      isCurrent ? "text-[#7c693d] font-semibold" : "text-gray-500"
                    }`}
                  >
                    <span
